...
- **Bookmark your places.** Star the location you're viewing and jump back to any saved place from the "Saved" dropdown in the nav. Bookmarks live in your browser (localStorage).
...
│  ├─ WeatherView.tsx     # "use client" weather shell (units/search/geolocation/bookmarks)
...
│  ├─ BookmarksMenu.tsx   # "use client" saved-locations dropdown
...
└─ hooks/
   ...
   └─ useBookmarks.ts      # localStorage saved locations

tests/                     # Vitest (jsdom): mirrors src/ — pure-logic units,
                           # the provider adapter, the useGeolocation/useBookmarks
                           # hooks, and component tests of the forecast views
```
